...
\fancyhead[C]{Patrones de diseño $\bullet$ Agosto 2021 $\bullet$ } % Custom header text
...
\item  \textbf{Ejemplo Observer}
 \includegraphics[width=7cm, height=7cm]{imagenes/patron_observer_1.png}
\item  \textbf{Clase Observer Usuario}
 \includegraphics[width=7cm, height=7cm]{imagenes/patron_observer_2.png}
\item  \textbf{Clase Sujeto Producto}
 \includegraphics[width=7cm, height=7cm]{imagenes/patron_observer_3.png}
